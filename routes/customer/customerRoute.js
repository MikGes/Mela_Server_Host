      ...
      html: `
        ...
        <div style="padding: 20px;">
          ...
          <div style="text-align: center; margin-top: 20px;">
            <a href="https://mela-server-host.onrender.com/customer/verifyCustomerEmail/${VerificationToken}" style="display: inline-block; background-color: #007bff; color: #ffffff; font-size: 16px; padding: 10px 20px; text-decoration: none; border-radius: 5px;">Verify Email</a>
          </div>
        </div>
      `,
    };
